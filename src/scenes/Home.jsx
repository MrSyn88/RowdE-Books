...
import { collection, doc, QuerySnapshot, getDocs } from 'firebase/firestore';
...
const Home = () => {
    ...
    let title1 = objs[randomNumber(1,20)]
    let title2 = objs[randomNumber(1,20)]
    let title3 = objs[randomNumber(1,20)]
